...
namespace capaspresentacionWF
{
    public partial class MDIRecursos : Form
    {
        ...
        private void salirtoolsStringMenuItem_Click(object sender, EventArgs e)
        {
            if (preclosingconfirmtion() == System.Windows.Forms.DialogResult.Yes)
            {
                Dispose(true);
                Application.Exit();
            }
        ...
        private DialogResult preclosingconfirmtion()
        {
